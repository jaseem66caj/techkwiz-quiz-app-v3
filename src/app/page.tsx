              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  onClick={() => {
                    ...
                    // Track navigation to quiz categories
                    Sentry.addBreadcrumb({
                      ...
                      data: {
                        ...
                        quizCompleted: true,
                        source: 'homepage_quiz_completion'
                      }
                    });

                    router.push('/start');
                  }}
                  className="flex-1 bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-xl transition-colors"
                >
